...
const StaffLeaveLetters = ({ navigation }) => {
    ...
    return (
        <LinearGradient colors={[colors.orangeColor, colors.primaryColor]} style={styles.gradient}>
            <View style={styles.topView}>
                ...
                <Text style={styles.title}>Staff Leave Letters</Text>
            </View>
                    ...
                    renderItem={({ item, index }) => (
                        item.present && (
                            <LinearGradient colors={[colors.white, colors.white]} style={styles.item}>
                                ...
                                {/* <Image source={item.image} height={40} width={40} style={styles.img} /> */}
...
export default StaffLeaveLetters;
